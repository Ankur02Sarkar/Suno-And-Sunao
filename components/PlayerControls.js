    ...
    <div className={styles.mainControl}>
        ...
        <div>
            <div className={styles.controlIconsContainer}>
                ...
                {isPaused ? <div className={styles.playIcon} onClick={play}><Image src={playRounded} alt="play"/></div> : <div className={styles.pauseIconStyle} onClick={pause}><Image src={pauseIcon} alt='pause'/></div>}
